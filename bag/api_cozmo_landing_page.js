$("#formInfo").submit(function (event) {
  ...
  fetch("https://cors-anywhere.herokuapp.com/https://script.google.com/macros/s/AKfycbxBfkWk93zt9ZtsTnDoXAEol95wOl3a3YM_Ald8nj1WnEXj2MQKx5JCdDXs4Z_behq-Cg/exec", {
    method: "POST",
    headers: {
