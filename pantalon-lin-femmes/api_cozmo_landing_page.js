...
// Get the updated data from the form
  ...
  var product_color2 = $('#formInfo select[name="product_color2"]').val();
  var product_color3 = $('#formInfo select[name="product_color3"]').val();
...
// Create the data object for SheetDB
  ...
  var sheetDBData = {
    marchandise : "Pantalon-Lin-femmes",
    client : fullname,
    tlphone : phone,
    ville : "-",
    ...
    tag : "",
    quantity: variant,
    color: product_color + "/" + product_color2 + "/" + product_color3,
    size: product_size,
